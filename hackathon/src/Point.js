class Point {
  ...
  constrain(Instance) {
    ...
    if (this.pos.x > Instance.WIDTH - this.radius) {
      this.pos.x = Instance.WIDTH - this.radius;
    ...
    if (this.pos.y > Instance.HEIGHT - this.radius) {
      this.pos.y = Instance.HEIGHT - this.radius;
  ...
  update(Instance) {
    ...
    if (this.pos.y >= Instance.HEIGHT - this.radius && vel.magSq() > 0.000001) {
      var m = vel.mag();
      vel.x /= m;
      vel.y /= m;
