window.onload = function () {
  let examples = [
    { title: 'Dynamics', src: './examples/Dynamics.html' },
    { title: 'A wheel', src: './examples/wheel.html' },
    { title: 'Air particals', src: './examples/particals.html' },
    { title: 'Flying Robot', src: './examples/Robot.html' },
    { title: 'Curtain', src: './examples/Curtain.html' },
